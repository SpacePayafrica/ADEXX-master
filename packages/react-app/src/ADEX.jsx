...
const rewardToken = "GovernanceToken";
...
const ADEX=({purpose, setPurposeEvents, address, mainnetProvider, userProvider,
  ...
  const isDarkMode=useSelector((state)=>state.isDark)
    ...
    const contractBalanceHex= useContractReader(writeContracts,"ADEX","balanceOfBNB",[address])
      ...
      <div className="main">
       ...
       <span className="icon">
         <span className="balance">
           ...
           <TokenBalance name={rewardToken} img={redDia} address={address} contracts={writeContracts}/>
         </span>
