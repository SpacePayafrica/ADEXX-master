...
const main = async () => {
  ...
  console.log("\n\n 📡 Deploying...\n");
   ...
   const africaToken = await deploy("AfricaToken",[oracle.address]) 
 
   const adex =  await(deploy("ADEX",[africaToken.address,governanceToken.address]))
   await africaToken.transfer("0x53a1451310881f3A2843a372C0D6f8dbc9C32E1F",""+(10*10**18));
  ...
  await adex.init(ethers.utils.parseEther('5'),{value:ethers.utils.parseEther('6')})
 
  // const deployerWallet = ethers.provider.getSigner()
  // console.log("Init Account with BNB")
 
  // await deployerWallet.sendTransaction({
  //   to: "0x53a1451310881f3A2843a372C0D6f8dbc9C32E1F",
